...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  body.o brain.o cord.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
body.o: /cygdrive/C/eclipse/workspace/HMC/body.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
brain.o: /cygdrive/C/eclipse/workspace/HMC/brain.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
cord.o: /cygdrive/C/eclipse/workspace/HMC/cord.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
...
#^|
body.o: /cygdrive/C/eclipse/workspace/HMC/body.cpp \
 /cygdrive/C/eclipse/workspace/HMC/body.h \
...
brain.o: /cygdrive/C/eclipse/workspace/HMC/brain.cpp \
 /cygdrive/C/eclipse/workspace/HMC/brain.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
cord.o: /cygdrive/C/eclipse/workspace/HMC/cord.cpp \
 /cygdrive/C/eclipse/workspace/HMC/cord.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
